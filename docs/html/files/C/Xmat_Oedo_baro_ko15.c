...
int main() {
   char materialname[80] = "Baro-Ko15_Hostun Sand 01";

   double voidratio = 0.7;
   double p_val_materialparameters[num_materialparameters] = {0.5899, 1.0, -2.5076, 1.0, 40.0, 0.91, 0.5};
