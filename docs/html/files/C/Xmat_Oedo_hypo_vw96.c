...
int main() {
   char materialname[80] = "Hypo-VW96_Hostun Sand 01";
   double nu = 0.25;
   double voidratio = 0.7;
   double p_val_materialparameters[num_materialparameters] = {0.576, nu, 1.0e6, 0.29, 0.63, 1.0, 1.15, 0.13, 2.0,
      2.0, 5.0, 1.0e-4, 0.5, 6.0, 0.0, 0.0};
   double intergranular_strain[num_components] = {0.0, -0.0001, 0.0, 0.0, 0.0, 0.0};
   double p_val_statevariables[num_statevariables] = {voidratio, intergranular_strain[0], intergranular_strain[1],
      intergranular_strain[2], intergranular_strain[3], intergranular_strain[3], intergranular_strain[4],
