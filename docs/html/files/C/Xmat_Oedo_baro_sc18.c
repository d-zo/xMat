...
int main() {
   char materialname[80] = "Baro-Sc18_Hostun Sand 01";

   double voidratio = 0.75;
   double p_val_materialparameters[num_materialparameters] = {0.5899, 430.0, 0.74, 3.0, 0.904, 1.093, 3.0, 5.0, 10.0};
